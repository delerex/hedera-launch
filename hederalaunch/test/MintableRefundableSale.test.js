...
const TOKENSALE  = "MintableRefundableSale";
const RATE = 10;
const PURCHASE = 1;
...
contract(TOKENSALE, function ([ minter, buyer, ...otherAccounts]) {
  beforeEach(async function () {
    ...
    const launchTime = block.timestamp;
    //console.log(this.token.address, block, launchTime);
    this.tokensale = await TokenSaleMintableMock.new(launchTime, launchTime + 100000, RATE, minter, CAP, this.token.address, GOAL, { from: minter });
  });
