...
contract(TOKEN, function ([ initialHolder, recipient, anotherAccount]) {
  const initialSupply = new BN(10).pow(new BN(18)).mul(new BN(INITIAL_SUPPLY) );

  console.log("Accounts", initialHolder, recipient, anotherAccount);
